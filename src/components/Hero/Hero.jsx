...
const Hero = () => {
  return (
    <>
      <section>
        <div className="container grid grid-cols-1 relative md:grid-cols-2 min-h-[650px]">
          <div
          ...
          >
            ...
            >
              ...
              >
                ...
                deleniti possimus incidunt doloribus, blanditiis alias
                praesentium atque quas.
              </motion.p>
              <motion.div
